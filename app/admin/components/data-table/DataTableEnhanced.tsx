...
export function DataTableEnhanced<TData, TValue>({
  ...
  const autoGeneratedActions = React.useMemo(() => {
    ...
    // Solo incluir botón de crear en el header (refresh y export van en toolbar)
    if (onCreate) {
      actions.push({
        key: "create",
        label: "Crear",
    ...
    // NO incluir refresh y export aquí - van en el toolbar
    // Esto evita duplicación de botones
